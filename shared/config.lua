...
Config.Shops = {
    ...
    ['Police Armoury'] = { -- the key is the shop name
        ...
        inventory = {
            -- define items and their prices below that can be purchased at this particular vendor - ensure these are in your items.lua!
            { name = 'weapon_nightstick',   price = 0, amount = 1,  requiresLicense = 'weapon', requiresJob = {'police', 'bsco', 'leo',}, },
            { name = 'weapon_flashlight',   price = 0, amount = 1,  requiresLicense = 'weapon', requiresJob = {'police', 'bsco', 'leo',}, },
            { name = 'handcuffs',           price = 0, amount = 50, requiresLicense = 'weapon', requiresJob = {'police', 'bsco', 'leo',}, },
            { name = 'empty_evidence_bag',  price = 0, amount = 50, requiresLicense = 'weapon', requiresJob = {'police', 'bsco', 'leo',}, },
            { name = 'police_stormram',     price = 0, amount = 50, requiresLicense = 'weapon', requiresJob = {'police', 'bsco', 'leo',}, },
            { name = 'radio',               price = 0, amount = 50, requiresLicense = 'weapon', requiresJob = {'police', 'bsco', 'leo',}, },
            { name = 'heavyarmor',          price = 0, amount = 50, requiresLicense = 'weapon', requiresJob = {'police', 'bsco', 'leo',}, },
            { name = 'weapon_stungun',      price = 0, amount = 1,  requiresLicense = 'weapon', requiresJob = {'police', 'bsco', 'leo',}, },
